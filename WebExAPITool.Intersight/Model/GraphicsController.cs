...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GraphicsController :  IEquatable<GraphicsController>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets GraphicsCard
        /// </summary>
        [DataMember(Name="GraphicsCard", EmitDefaultValue=false)]
        public GraphicsCardRef GraphicsCard { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GraphicsController {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GraphicsController);
        }

        /// <summary>
        /// Returns true if GraphicsController instances are equal
        /// </summary>
        /// <param name="other">Instance of GraphicsController to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GraphicsController other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.GraphicsCard == other.GraphicsCard ||
                    this.GraphicsCard != null &&
                    this.GraphicsCard.Equals(other.GraphicsCard)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GraphicsCard != null)
                    hash = hash * 59 + this.GraphicsCard.GetHashCode();
