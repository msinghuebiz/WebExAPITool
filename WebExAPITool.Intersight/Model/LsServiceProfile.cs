...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LsServiceProfile :  IEquatable<LsServiceProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LsServiceProfile" /> class.
        /// </summary>
        ...
        public LsServiceProfile(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        /// <summary>
        /// Gets or Sets AssignState
        /// </summary>
        [DataMember(Name="AssignState", EmitDefaultValue=false)]
        public string AssignState { get; private set; }

        /// <summary>
        /// Gets or Sets AssocState
        /// </summary>
        [DataMember(Name="AssocState", EmitDefaultValue=false)]
        public string AssocState { get; private set; }

        /// <summary>
        /// Gets or Sets AssociatedServer
        /// </summary>
        [DataMember(Name="AssociatedServer", EmitDefaultValue=false)]
        public string AssociatedServer { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LsServiceProfile {\n");
            ...
            sb.Append("  AssignState: ").Append(AssignState).Append("\n");
            sb.Append("  AssocState: ").Append(AssocState).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LsServiceProfile);
        }

        /// <summary>
        /// Returns true if LsServiceProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of LsServiceProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LsServiceProfile other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssignState == other.AssignState ||
                    this.AssignState != null &&
                    this.AssignState.Equals(other.AssignState)
                ) && 
                (
                    this.AssocState == other.AssocState ||
                    this.AssocState != null &&
                    this.AssocState.Equals(other.AssocState)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssignState != null)
                    hash = hash * 59 + this.AssignState.GetHashCode();
                if (this.AssocState != null)
                    hash = hash * 59 + this.AssocState.GetHashCode();
