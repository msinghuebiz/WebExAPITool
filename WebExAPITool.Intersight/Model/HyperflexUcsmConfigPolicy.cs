...
{
    /// <summary>
    /// Specifies UCS Manager settings such as service profile org, KVM IP addresses, and MAC prefix for server configuration in Fabric Interconnect environment 
    /// </summary>
    [DataContract]
    public partial class HyperflexUcsmConfigPolicy :  IEquatable<HyperflexUcsmConfigPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Out-of-band KVM IP range  </value>
        [DataMember(Name="KvmIpRange", EmitDefaultValue=false)]
        public HyperflexIpAddrRange KvmIpRange { get; set; }

        /// <summary>
        /// MAC address prefix range  
        /// </summary>
        /// <value>MAC address prefix range  </value>
        [DataMember(Name="MacPrefixRange", EmitDefaultValue=false)]
        public HyperflexMacAddrPrefixRange MacPrefixRange { get; set; }
        ...
        /// </summary>
        /// <value>Specifies server firmware bundle version used for server components such as CIMC, adapters, BIOS, etc.   </value>
        [DataMember(Name="ServerFirmwareVersion", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HyperflexUcsmConfigPolicy {\n");
            ...
            sb.Append("  KvmIpRange: ").Append(KvmIpRange).Append("\n");
            sb.Append("  MacPrefixRange: ").Append(MacPrefixRange).Append("\n");
            sb.Append("  Organization: ").Append(Organization).Append("\n");
            sb.Append("  ServerFirmwareVersion: ").Append(ServerFirmwareVersion).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HyperflexUcsmConfigPolicy);
        }

        /// <summary>
        /// Returns true if HyperflexUcsmConfigPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of HyperflexUcsmConfigPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperflexUcsmConfigPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.KvmIpRange == other.KvmIpRange ||
                    this.KvmIpRange != null &&
                    this.KvmIpRange.Equals(other.KvmIpRange)
                ) && 
                (
                    this.MacPrefixRange == other.MacPrefixRange ||
                    this.MacPrefixRange != null &&
                    this.MacPrefixRange.Equals(other.MacPrefixRange)
                ) && 
                (
                ...
                (
                    this.ServerFirmwareVersion == other.ServerFirmwareVersion ||
                    this.ServerFirmwareVersion != null &&
                    this.ServerFirmwareVersion.Equals(other.ServerFirmwareVersion)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KvmIpRange != null)
                    hash = hash * 59 + this.KvmIpRange.GetHashCode();
                if (this.MacPrefixRange != null)
                    hash = hash * 59 + this.MacPrefixRange.GetHashCode();
                if (this.Organization != null)
                    hash = hash * 59 + this.Organization.GetHashCode();
                if (this.ServerFirmwareVersion != null)
                    hash = hash * 59 + this.ServerFirmwareVersion.GetHashCode();
                return hash;
            }
        }
