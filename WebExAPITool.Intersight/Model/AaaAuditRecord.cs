...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class AaaAuditRecord :  IEquatable<AaaAuditRecord>, IValidatableObject
    {
        ...
        public AaaAuditRecord(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string _Event = default(string), string MoType = default(string), string ObjectMoid = default(string), Object Request = default(Object), string TraceId = default(string), IamAccountRef Account = default(IamAccountRef), string InstId = default(string), IamSessionRef Sessions = default(IamSessionRef), string SourceIp = default(string), IamUserRef User = default(IamUserRef))
        {
