...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class ComputeBoard :  IEquatable<ComputeBoard>, IValidatableObject
    {
        ...
        public ComputeBoard(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), ComputeBladeRef ComputeBlade = default(ComputeBladeRef), ComputeRackUnitRef ComputeRackUnit = default(ComputeRackUnitRef), List<GraphicsCardRef> GraphicsCards = default(List<GraphicsCardRef>), List<MemoryArrayRef> MemoryArrays = default(List<MemoryArrayRef>), List<ProcessorUnitRef> Processors = default(List<ProcessorUnitRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<SecurityUnitRef> SecurityUnits = default(List<SecurityUnitRef>), List<StorageControllerRef> StorageControllers = default(List<StorageControllerRef>), List<StorageFlexFlashControllerRef> StorageFlexFlashControllers = default(List<StorageFlexFlashControllerRef>), List<StorageFlexUtilControllerRef> StorageFlexUtilControllers = default(List<StorageFlexUtilControllerRef>))
        {
