...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class AssetDeviceRegistration :  IEquatable<AssetDeviceRegistration>, IValidatableObject
    {
        ...
        /// <param name="AccessKey">Part of the credential used for the device connector to authenticate with the cloud. Depricated - see &#39;publicAccessKey&#39;.  .</param>
        ...
        /// <param name="ExecutionMode">Indicates if the platform is an actual device or an emulated device for testing, demos, etc. Permitted values [Normal, Emulator, ContainerEmulator]  .</param>
        ...
        /// <param name="PublicAccessKey">The device connector&#39;s public key used by the cloud to authenticate a connection from the device connector. The public key is used to verify that the signature a device connector sends on connect has been signed by the connector&#39;s private key stored on the device&#39;s filesystem. Must be a PEM encoded RSA public key string.  .</param>
        /// <param name="PublicKeyUpgraded">Flag marks the upgrade of a devices authentication from symmetric keys to asymetric public/private key. Devices update the Intersight service with their new public keys on connect with a REST stim, the new public key will not be enforced until the device authenticates with the key for the first time. This is done to handle the case where a device has generated a new key pair and sent the update to the cloud, but the response from the Intersight service is dropped, in which case the device will continue to use the original access key pair.  .</param>
        ...
        public AssetDeviceRegistration(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string AccessKey = default(string), string AccessKeyId = default(string), IamAccountRef Account = default(IamAccountRef), IamUserRef ClaimedByUser = default(IamUserRef), AssetDeviceClaimRef DeviceClaim = default(AssetDeviceClaimRef), AssetDeviceConfigurationRef DeviceConfiguration = default(AssetDeviceConfigurationRef), List<string> DeviceHostname = default(List<string>), List<string> DeviceIpAddress = default(List<string>), IamDomainGroupRef DomainGroup = default(IamDomainGroupRef), string ExecutionMode = default(string), List<string> Pid = default(List<string>), PlatformTypeEnum? PlatformType = null, string PublicAccessKey = default(string), bool? PublicKeyUpgraded = default(bool?), AssetSecurityTokenRef SecurityToken = default(AssetSecurityTokenRef), List<string> Serial = default(List<string>))
        {
            ...
            this.PublicKeyUpgraded = PublicKeyUpgraded;
        ...
        /// <summary>
        /// Part of the credential used for the device connector to authenticate with the cloud. Depricated - see &#39;publicAccessKey&#39;.  
        /// </summary>
        /// <value>Part of the credential used for the device connector to authenticate with the cloud. Depricated - see &#39;publicAccessKey&#39;.  </value>
        ...
        /// <summary>
        /// Flag marks the upgrade of a devices authentication from symmetric keys to asymetric public/private key. Devices update the Intersight service with their new public keys on connect with a REST stim, the new public key will not be enforced until the device authenticates with the key for the first time. This is done to handle the case where a device has generated a new key pair and sent the update to the cloud, but the response from the Intersight service is dropped, in which case the device will continue to use the original access key pair.  
        /// </summary>
        /// <value>Flag marks the upgrade of a devices authentication from symmetric keys to asymetric public/private key. Devices update the Intersight service with their new public keys on connect with a REST stim, the new public key will not be enforced until the device authenticates with the key for the first time. This is done to handle the case where a device has generated a new key pair and sent the update to the cloud, but the response from the Intersight service is dropped, in which case the device will continue to use the original access key pair.  </value>
        [DataMember(Name="PublicKeyUpgraded", EmitDefaultValue=false)]
        public bool? PublicKeyUpgraded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PublicKeyUpgraded: ").Append(PublicKeyUpgraded).Append("\n");
        ...
        public bool Equals(AssetDeviceRegistration other)
        {
            ...
            return 
                ...
                (
                    this.PublicKeyUpgraded == other.PublicKeyUpgraded ||
                    this.PublicKeyUpgraded != null &&
                    this.PublicKeyUpgraded.Equals(other.PublicKeyUpgraded)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PublicKeyUpgraded != null)
                    hash = hash * 59 + this.PublicKeyUpgraded.GetHashCode();
