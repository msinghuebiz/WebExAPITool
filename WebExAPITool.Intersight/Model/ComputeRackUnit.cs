...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComputeRackUnit :  IEquatable<ComputeRackUnit>, IValidatableObject
    {
        /// <summary>
        ...
        public ComputeRackUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), long? FaultSummary = default(long?), List<ComputeIpAddress> KvmIpAddresses = default(List<ComputeIpAddress>), string PlatformType = default(string), List<AdapterUnitRef> Adapters = default(List<AdapterUnitRef>), List<BiosUnitRef> Biosunits = default(List<BiosUnitRef>), ManagementControllerRef Bmc = default(ManagementControllerRef), ComputeBoardRef Board = default(ComputeBoardRef), List<EquipmentFanModuleRef> Fanmodules = default(List<EquipmentFanModuleRef>), List<InventoryGenericInventoryHolderRef> GenericInventoryHolders = default(List<InventoryGenericInventoryHolderRef>), EquipmentLocatorLedRef LocatorLed = default(EquipmentLocatorLedRef), List<EquipmentPsuRef> Psus = default(List<EquipmentPsuRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<StorageSasExpanderRef> SasExpanders = default(List<StorageSasExpanderRef>), List<StorageEnclosureRef> StorageEnclosures = default(List<StorageEnclosureRef>), TopSystemRef TopSystem = default(TopSystemRef))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComputeRackUnit {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ComputeRackUnit);
        }

        /// <summary>
        /// Returns true if ComputeRackUnit instances are equal
        /// </summary>
        /// <param name="other">Instance of ComputeRackUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComputeRackUnit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
