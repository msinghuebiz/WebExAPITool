...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class InventoryGenericInventory :  IEquatable<InventoryGenericInventory>, IValidatableObject
    {
        ...
        public InventoryGenericInventory(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), InventoryGenericInventoryHolderRef InventoryGenericInventoryHolder = default(InventoryGenericInventoryHolderRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
