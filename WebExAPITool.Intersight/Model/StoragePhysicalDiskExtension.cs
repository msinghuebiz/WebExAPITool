...
{
    /// <summary>
    /// Information of disks as reported by controller. In certain cases like S-series servers, disk information will be reported by controller separately and this MO is primarily meant for represent such information about the disks 
    /// </summary>
    [DataContract]
    public partial class StoragePhysicalDiskExtension :  IEquatable<StoragePhysicalDiskExtension>, IValidatableObject
    {
        /// <summary>
        ...
        public StoragePhysicalDiskExtension(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), StoragePhysicalDiskRef PhysicalDisk = default(StoragePhysicalDiskRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), StorageControllerRef StorageController = default(StorageControllerRef))
        {
        ...
        /// Gets or Sets DiskDn
        /// </summary>
        [DataMember(Name="DiskDn", EmitDefaultValue=false)]
        public string DiskDn { get; private set; }

        /// <summary>
        /// Gets or Sets DiskId
        /// </summary>
        [DataMember(Name="DiskId", EmitDefaultValue=false)]
        public long? DiskId { get; private set; }
        ...
        /// <summary>
        /// Gets or Sets PhysicalDisk
        /// </summary>
        [DataMember(Name="PhysicalDisk", EmitDefaultValue=false)]
        public StoragePhysicalDiskRef PhysicalDisk { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoragePhysicalDiskExtension {\n");
            ...
            sb.Append("  DiskDn: ").Append(DiskDn).Append("\n");
            sb.Append("  DiskId: ").Append(DiskId).Append("\n");
            sb.Append("  DiskState: ").Append(DiskState).Append("\n");
            sb.Append("  PhysicalDisk: ").Append(PhysicalDisk).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StoragePhysicalDiskExtension);
        }

        /// <summary>
        /// Returns true if StoragePhysicalDiskExtension instances are equal
        /// </summary>
        /// <param name="other">Instance of StoragePhysicalDiskExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoragePhysicalDiskExtension other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.DiskDn == other.DiskDn ||
                    this.DiskDn != null &&
                    this.DiskDn.Equals(other.DiskDn)
                ) && 
                (
                ...
                (
                    this.PhysicalDisk == other.PhysicalDisk ||
                    this.PhysicalDisk != null &&
                    this.PhysicalDisk.Equals(other.PhysicalDisk)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DiskDn != null)
                    hash = hash * 59 + this.DiskDn.GetHashCode();
                if (this.DiskId != null)
                    hash = hash * 59 + this.DiskId.GetHashCode();
                if (this.DiskState != null)
                    hash = hash * 59 + this.DiskState.GetHashCode();
                if (this.PhysicalDisk != null)
                    hash = hash * 59 + this.PhysicalDisk.GetHashCode();
