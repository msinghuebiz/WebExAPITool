...
{
    /// <summary>
    /// EndPointRole represents a role defined in end point which can be managed by system. 
    /// </summary>
    [DataContract]
    public partial class IamEndPointRole :  IEquatable<IamEndPointRole>, IValidatableObject
    {
        /// <summary>
        /// Type of the end point    
        /// </summary>
        /// <value>Type of the end point    </value>
        ...
        public IamEndPointRole(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamAccountRef Account = default(IamAccountRef), List<IamEndPointPrivilegeRef> EndPointPrivileges = default(List<IamEndPointPrivilegeRef>), IamSystemRef System = default(IamSystemRef))
        {
        ...
        /// </summary>
        /// <value>Name of the end point role   </value>
        [DataMember(Name="Name", EmitDefaultValue=false)]
        public string Name { get; private set; }

        /// <summary>
        /// Used to tags roles as special default role types common across endpoints  
        /// </summary>
        /// <value>Used to tags roles as special default role types common across endpoints  </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IamEndPointRole {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IamEndPointRole);
        }

        /// <summary>
        /// Returns true if IamEndPointRole instances are equal
        /// </summary>
        /// <param name="other">Instance of IamEndPointRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IamEndPointRole other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.RoleType != null &&
                    this.RoleType.Equals(other.RoleType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoleType != null)
                    hash = hash * 59 + this.RoleType.GetHashCode();
                if (this.System != null)
