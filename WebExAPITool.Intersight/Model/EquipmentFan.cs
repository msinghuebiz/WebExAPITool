...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentFan :  IEquatable<EquipmentFan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentFan" /> class.
        /// </summary>
        ...
        /// <param name="EquipmentFanModule">EquipmentFanModule.</param>
        /// <param name="RegisteredDevice">RegisteredDevice.</param>
        public EquipmentFan(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), EquipmentFanModuleRef EquipmentFanModule = default(EquipmentFanModuleRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
            ...
            this.Parent = Parent;
            this.Tags = Tags;
            this.EquipmentFanModule = EquipmentFanModule;
        ...
        /// <summary>
        /// Gets or Sets EquipmentFanModule
        /// </summary>
        [DataMember(Name="EquipmentFanModule", EmitDefaultValue=false)]
        public EquipmentFanModuleRef EquipmentFanModule { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EquipmentFanModule: ").Append(EquipmentFanModule).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentFan);
        }

        /// <summary>
        /// Returns true if EquipmentFan instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentFan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentFan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.EquipmentFanModule == other.EquipmentFanModule ||
                    this.EquipmentFanModule != null &&
                    this.EquipmentFanModule.Equals(other.EquipmentFanModule)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EquipmentFanModule != null)
                    hash = hash * 59 + this.EquipmentFanModule.GetHashCode();
