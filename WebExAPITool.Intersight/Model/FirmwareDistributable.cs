...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class FirmwareDistributable :  IEquatable<FirmwareDistributable>, IValidatableObject
    {
        ...
        public FirmwareDistributable(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<string> SupportedModels = default(List<string>))
        {
