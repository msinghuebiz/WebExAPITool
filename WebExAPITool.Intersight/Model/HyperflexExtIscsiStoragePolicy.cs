...
{
    /// <summary>
    /// Specifies external storage connectivity information via Fabric attached FCoE storage 
    /// </summary>
    [DataContract]
    public partial class HyperflexExtIscsiStoragePolicy :  IEquatable<HyperflexExtIscsiStoragePolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HyperflexExtIscsiStoragePolicy" /> class.
        /// </summary>
        ...
        /// <param name="AdminState">Enable or disable external FCoE storage configuration  .</param>
        /// <param name="ClusterProfiles">List of cluster profiles using this policy .</param>
        /// <param name="ExtaTraffic">VLAN for the primary Fabric Interconnect external FCoE storage traffic  .</param>
        /// <param name="ExtbTraffic">VLAN for the secondary Fabric Interconnect external FCoE storage traffic   .</param>
        /// <param name="Organization">Organization .</param>
        public HyperflexExtIscsiStoragePolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), bool? AdminState = default(bool?), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), HyperflexNamedVlan ExtaTraffic = default(HyperflexNamedVlan), HyperflexNamedVlan ExtbTraffic = default(HyperflexNamedVlan), IamAccountRef Organization = default(IamAccountRef))
        {
        ...
        /// </summary>
        /// <value>Enable or disable external FCoE storage configuration  </value>
        ...
        /// </summary>
        /// <value>VLAN for the primary Fabric Interconnect external FCoE storage traffic  </value>
        [DataMember(Name="ExtaTraffic", EmitDefaultValue=false)]
        public HyperflexNamedVlan ExtaTraffic { get; set; }

        /// <summary>
        /// VLAN for the secondary Fabric Interconnect external FCoE storage traffic   
        /// </summary>
        /// <value>VLAN for the secondary Fabric Interconnect external FCoE storage traffic   </value>
        [DataMember(Name="ExtbTraffic", EmitDefaultValue=false)]
        public HyperflexNamedVlan ExtbTraffic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HyperflexExtIscsiStoragePolicy {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HyperflexExtIscsiStoragePolicy);
        }

        /// <summary>
        /// Returns true if HyperflexExtIscsiStoragePolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of HyperflexExtIscsiStoragePolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperflexExtIscsiStoragePolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
