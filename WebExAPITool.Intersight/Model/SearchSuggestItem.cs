...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class SearchSuggestItem :  IEquatable<SearchSuggestItem>, IValidatableObject
    {
        ...
        public SearchSuggestItem(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), bool? CompleteMo = default(bool?), string Rawquery = default(string), long? Skip = default(long?), string SuggestTerm = default(string), long? Top = default(long?), string Type = default(string))
        {
