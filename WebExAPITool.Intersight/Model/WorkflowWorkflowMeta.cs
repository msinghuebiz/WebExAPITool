...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class WorkflowWorkflowMeta :  IEquatable<WorkflowWorkflowMeta>, IValidatableObject
    {
        ...
        /// <summary>
        /// The list of tasks contained inside the workflow 
        /// </summary>
        /// <value>The list of tasks contained inside the workflow </value>
        [DataMember(Name="WorkflowTasks", EmitDefaultValue=false)]
        public List<WorkflowWorkflowTaskRef> WorkflowTasks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorkflowTasks: ").Append(WorkflowTasks).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(WorkflowWorkflowMeta other)
        {
            ...
            return 
                ...
                (
                    this.WorkflowTasks == other.WorkflowTasks ||
                    this.WorkflowTasks != null &&
                    this.WorkflowTasks.SequenceEqual(other.WorkflowTasks)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WorkflowTasks != null)
                    hash = hash * 59 + this.WorkflowTasks.GetHashCode();
                return hash;
            }
        }
