...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HclHardwareCompatibilityProfile :  IEquatable<HclHardwareCompatibilityProfile>, IValidatableObject
    {
        ...
        public HclHardwareCompatibilityProfile(string Id = default(string), string OsVendor = default(string), string OsVersion = default(string), string ProcessorModel = default(string), List<HclProduct> Products = default(List<HclProduct>), string ServerModel = default(string), string ServerRevision = default(string), string UcsVersion = default(string), VersionTypeEnum? VersionType = VersionTypeEnum.UCSM)
        {
            this.Id = Id;
