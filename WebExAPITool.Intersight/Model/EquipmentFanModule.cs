...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentFanModule :  IEquatable<EquipmentFanModule>, IValidatableObject
    {
        /// <summary>
        ...
        public List<EquipmentFanRef> Fans { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentFanModule {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentFanModule);
        }

        /// <summary>
        /// Returns true if EquipmentFanModule instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentFanModule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentFanModule other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Fans != null &&
                    this.Fans.SequenceEqual(other.Fans)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Fans != null)
                    hash = hash * 59 + this.Fans.GetHashCode();
