...
{
    /// <summary>
    /// Represents the results details information. 
    /// </summary>
    [DataContract]
    public partial class PolicyAbstractConfigResultEntry :  IEquatable<PolicyAbstractConfigResultEntry>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyAbstractConfigResultEntry {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PolicyAbstractConfigResultEntry);
        }

        /// <summary>
        /// Returns true if PolicyAbstractConfigResultEntry instances are equal
        /// </summary>
        /// <param name="other">Instance of PolicyAbstractConfigResultEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyAbstractConfigResultEntry other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
