...
{
    /// <summary>
    /// Represents the results with the overall state and detailed result messages. 
    /// </summary>
    [DataContract]
    public partial class PolicyAbstractConfigResult :  IEquatable<PolicyAbstractConfigResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyAbstractConfigResult" /> class.
        /// </summary>
        ...
        public PolicyAbstractConfigResult(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string ConfigStage = default(string), string ConfigState = default(string), string ValidationState = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyAbstractConfigResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PolicyAbstractConfigResult);
        }

        /// <summary>
        /// Returns true if PolicyAbstractConfigResult instances are equal
        /// </summary>
        /// <param name="other">Instance of PolicyAbstractConfigResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyAbstractConfigResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
