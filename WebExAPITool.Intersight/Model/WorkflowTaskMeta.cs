...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class WorkflowTaskMeta :  IEquatable<WorkflowTaskMeta>, IValidatableObject
    {
        ...
        public WorkflowTaskMeta(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string ActionType = default(string), string Description = default(string), List<string> InputKeys = default(List<string>), string Name = default(string), List<string> OutputKeys = default(List<string>), long? ResponseTimeoutSec = default(long?), long? RetryCount = default(long?), long? RetryDelaySec = default(long?), string RetryLogic = default(string), string Src = default(string), string TimeoutPolicy = default(string), long? TimeoutSec = default(long?))
        {
