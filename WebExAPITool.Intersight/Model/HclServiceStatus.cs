...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HclServiceStatus :  IEquatable<HclServiceStatus>, IValidatableObject
    {
        ...
        public HclServiceStatus(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Identity = default(string), DateTime? LastHclDataModifiedTime = default(DateTime?), string LastImportedDataChecksum = default(string), StatusEnum? Status = StatusEnum.Unknown)
        {
