...
namespace WebExAPITool.Intersight.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://intersight.com/api/v1).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://intersight.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://intersight.com/api/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://intersight.com/api/v1")
        {
