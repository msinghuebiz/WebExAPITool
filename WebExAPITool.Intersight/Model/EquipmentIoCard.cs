...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentIoCard :  IEquatable<EquipmentIoCard>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentIoCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentIoCard);
        }

        /// <summary>
        /// Returns true if EquipmentIoCard instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentIoCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentIoCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
