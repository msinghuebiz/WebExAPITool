...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexStPlatformClusterHealingInfo :  IEquatable<HyperflexStPlatformClusterHealingInfo>, IValidatableObject
    {
        ...
        public HyperflexStPlatformClusterHealingInfo(List<string> Messages = default(List<string>), HyperflexIteratorString MessagesIterator = default(HyperflexIteratorString))
        {
