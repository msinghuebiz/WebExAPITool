...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentSystemIoController :  IEquatable<EquipmentSystemIoController>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentSystemIoController" /> class.
        /// </summary>
        ...
        public EquipmentSystemIoController(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), EquipmentChassisRef EquipmentChassis = default(EquipmentChassisRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentSystemIoController {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentSystemIoController);
        }

        /// <summary>
        /// Returns true if EquipmentSystemIoController instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentSystemIoController to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentSystemIoController other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
