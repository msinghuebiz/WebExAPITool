...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexStPlatformClusterResiliencyInfo :  IEquatable<HyperflexStPlatformClusterResiliencyInfo>, IValidatableObject
    {
        ...
        public HyperflexStPlatformClusterResiliencyInfo(List<string> Messages = default(List<string>), HyperflexIteratorString MessagesIterator = default(HyperflexIteratorString))
        {
        ...
        public HyperflexIteratorString MessagesIterator { get; set; }
