...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BiosUnit :  IEquatable<BiosUnit>, IValidatableObject
    {
        /// <summary>
        ...
        public BiosUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), ComputeBladeRef ComputeBlade = default(ComputeBladeRef), ComputeRackUnitRef ComputeRackUnit = default(ComputeRackUnitRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<FirmwareRunningFirmwareRef> RunningFirmware = default(List<FirmwareRunningFirmwareRef>))
        {
        ...
        /// <summary>
        /// Gets or Sets InitSeq
        /// </summary>
        [DataMember(Name="InitSeq", EmitDefaultValue=false)]
        public string InitSeq { get; private set; }

        /// <summary>
        /// Gets or Sets InitTs
        /// </summary>
        [DataMember(Name="InitTs", EmitDefaultValue=false)]
        public string InitTs { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InitSeq: ").Append(InitSeq).Append("\n");
            sb.Append("  InitTs: ").Append(InitTs).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BiosUnit);
        }

        /// <summary>
        /// Returns true if BiosUnit instances are equal
        /// </summary>
        /// <param name="other">Instance of BiosUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BiosUnit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.InitSeq == other.InitSeq ||
                    this.InitSeq != null &&
                    this.InitSeq.Equals(other.InitSeq)
                ) && 
                (
                    this.InitTs == other.InitTs ||
                    this.InitTs != null &&
                    this.InitTs.Equals(other.InitTs)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InitSeq != null)
                    hash = hash * 59 + this.InitSeq.GetHashCode();
                if (this.InitTs != null)
                    hash = hash * 59 + this.InitTs.GetHashCode();
