...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NtpPolicy :  IEquatable<NtpPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NtpPolicy" /> class.
        /// </summary>
        ...
        /// <param name="Enabled">State of NTP service on the endpoint  .</param>
        /// <param name="NtpServers">Collection of NTP Server IP addresses or hostnames   .</param>
        /// <param name="Organization">Organization .</param>
        /// <param name="Profiles">Relationship to the profile objects .</param>
        public NtpPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), bool? Enabled = default(bool?), List<string> NtpServers = default(List<string>), IamAccountRef Organization = default(IamAccountRef), List<PolicyAbstractConfigProfileRef> Profiles = default(List<PolicyAbstractConfigProfileRef>))
        {
        ...
        /// </summary>
        /// <value>State of NTP service on the endpoint  </value>
        ...
        /// </summary>
        /// <value>Collection of NTP Server IP addresses or hostnames   </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NtpPolicy);
        }

        /// <summary>
        /// Returns true if NtpPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of NtpPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NtpPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
