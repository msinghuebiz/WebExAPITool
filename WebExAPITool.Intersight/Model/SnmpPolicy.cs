...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SnmpPolicy :  IEquatable<SnmpPolicy>, IValidatableObject
    {
        /// <summary>
        /// Controls access to the information in the inventory tables. Applicable only for SNMPv1 and SNMPv2c users.  
        /// </summary>
        /// <value>Controls access to the information in the inventory tables. Applicable only for SNMPv1 and SNMPv2c users.  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum CommunityAccessEnum
        {
        ...
        /// </summary>
        /// <value>Controls access to the information in the inventory tables. Applicable only for SNMPv1 and SNMPv2c users.  </value>
        [DataMember(Name="CommunityAccess", EmitDefaultValue=false)]
        public CommunityAccessEnum? CommunityAccess { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>The default SNMPv1, SNMPv2c community name or SNMPv3 username to include on any trap messages sent to the SNMP host. The name can be 18 characters long.  </value>
        [DataMember(Name="AccessCommunityString", EmitDefaultValue=false)]
        public string AccessCommunityString { get; set; }


        /// <summary>
        /// State of the SNMP Policy on the endpoint. If enabled, the endpoint sends SNMP traps to the designated host.  
        /// </summary>
        /// <value>State of the SNMP Policy on the endpoint. If enabled, the endpoint sends SNMP traps to the designated host.  </value>
        ...
        /// </summary>
        /// <value>User-defined unique identification of the static engine  </value>
        ...
        /// </summary>
        /// <value>Port on which Cisco IMC SNMP agent runs  </value>
        [DataMember(Name="SnmpPort", EmitDefaultValue=false)]
        public long? SnmpPort { get; set; }

        /// <summary>
        /// List of SNMP Traps  
        /// </summary>
        /// <value>List of SNMP Traps  </value>
        [DataMember(Name="SnmpTraps", EmitDefaultValue=false)]
        public List<SnmpTrap> SnmpTraps { get; set; }

        /// <summary>
        /// List of SNMP Users  
        /// </summary>
        /// <value>List of SNMP Users  </value>
        [DataMember(Name="SnmpUsers", EmitDefaultValue=false)]
        public List<SnmpUser> SnmpUsers { get; set; }
        ...
        /// </summary>
        /// <value>Contact person responsible for the SNMP implementation. Enter a string up to 64 characters, such as an email address or a name and telephone number.  </value>
        ...
        /// </summary>
        /// <value>Location of host on which the SNMP agent(server) runs  </value>
        ...
        /// </summary>
        /// <value>SNMP community group used for sending SNMP trap to other devices. Valid only for SNMPv2c users   </value>
        [DataMember(Name="TrapCommunity", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccessCommunityString: ").Append(AccessCommunityString).Append("\n");
            sb.Append("  CommunityAccess: ").Append(CommunityAccess).Append("\n");
            sb.Append("  Enabled: ").Append(Enabled).Append("\n");
            sb.Append("  EngineId: ").Append(EngineId).Append("\n");
            sb.Append("  Organization: ").Append(Organization).Append("\n");
            sb.Append("  Profiles: ").Append(Profiles).Append("\n");
            sb.Append("  SnmpPort: ").Append(SnmpPort).Append("\n");
            sb.Append("  SnmpTraps: ").Append(SnmpTraps).Append("\n");
            sb.Append("  SnmpUsers: ").Append(SnmpUsers).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SnmpPolicy);
        }

        /// <summary>
        /// Returns true if SnmpPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of SnmpPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnmpPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccessCommunityString == other.AccessCommunityString ||
                    this.AccessCommunityString != null &&
                    this.AccessCommunityString.Equals(other.AccessCommunityString)
                ) && 
                (
                    this.CommunityAccess == other.CommunityAccess ||
                    this.CommunityAccess != null &&
                    this.CommunityAccess.Equals(other.CommunityAccess)
                ) && 
                (
                ...
                (
                    this.SnmpPort == other.SnmpPort ||
                    this.SnmpPort != null &&
                    this.SnmpPort.Equals(other.SnmpPort)
                ) && 
                (
                    this.SnmpTraps == other.SnmpTraps ||
                    this.SnmpTraps != null &&
                    this.SnmpTraps.SequenceEqual(other.SnmpTraps)
                ) && 
                (
                    this.SnmpUsers == other.SnmpUsers ||
                    this.SnmpUsers != null &&
                    this.SnmpUsers.SequenceEqual(other.SnmpUsers)
                ) && 
                (
                    this.SysContact == other.SysContact ||
                    this.SysContact != null &&
                    this.SysContact.Equals(other.SysContact)
                ) && 
                (
                    this.SysLocation == other.SysLocation ||
                    this.SysLocation != null &&
                    this.SysLocation.Equals(other.SysLocation)
                ) && 
                (
                    this.TrapCommunity == other.TrapCommunity ||
                    this.TrapCommunity != null &&
                    this.TrapCommunity.Equals(other.TrapCommunity)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccessCommunityString != null)
                    hash = hash * 59 + this.AccessCommunityString.GetHashCode();
                if (this.CommunityAccess != null)
                    hash = hash * 59 + this.CommunityAccess.GetHashCode();
                ...
                if (this.SnmpPort != null)
                    hash = hash * 59 + this.SnmpPort.GetHashCode();
                if (this.SnmpTraps != null)
                    hash = hash * 59 + this.SnmpTraps.GetHashCode();
                if (this.SnmpUsers != null)
                    hash = hash * 59 + this.SnmpUsers.GetHashCode();
                if (this.SysContact != null)
                    hash = hash * 59 + this.SysContact.GetHashCode();
                if (this.SysLocation != null)
                    hash = hash * 59 + this.SysLocation.GetHashCode();
                if (this.TrapCommunity != null)
                    hash = hash * 59 + this.TrapCommunity.GetHashCode();
                return hash;
            }
        }
