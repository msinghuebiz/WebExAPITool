...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TestcryptCredential :  IEquatable<TestcryptCredential>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestcryptCredential {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TestcryptCredential);
        }

        /// <summary>
        /// Returns true if TestcryptCredential instances are equal
        /// </summary>
        /// <param name="other">Instance of TestcryptCredential to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestcryptCredential other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
