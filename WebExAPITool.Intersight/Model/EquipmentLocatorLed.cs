...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentLocatorLed :  IEquatable<EquipmentLocatorLed>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentLocatorLed {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentLocatorLed);
        }

        /// <summary>
        /// Returns true if EquipmentLocatorLed instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentLocatorLed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentLocatorLed other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
