...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentFex :  IEquatable<EquipmentFex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentFex" /> class.
        /// </summary>
        ...
        public EquipmentFex(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentFex);
        }

        /// <summary>
        /// Returns true if EquipmentFex instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentFex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentFex other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
