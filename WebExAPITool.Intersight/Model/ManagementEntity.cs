...
{
    /// <summary>
    /// Represents the UCSM managing instance - A / B 
    /// </summary>
    [DataContract]
    public partial class ManagementEntity :  IEquatable<ManagementEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManagementEntity {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ManagementEntity);
        }

        /// <summary>
        /// Returns true if ManagementEntity instances are equal
        /// </summary>
        /// <param name="other">Instance of ManagementEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagementEntity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
