...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InventoryBase :  IEquatable<InventoryBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryBase" /> class.
        /// </summary>
        ...
        public InventoryBase(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InventoryBase);
        }

        /// <summary>
        /// Returns true if InventoryBase instances are equal
        /// </summary>
        /// <param name="other">Instance of InventoryBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
