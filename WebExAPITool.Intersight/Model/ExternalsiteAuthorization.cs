...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExternalsiteAuthorization :  IEquatable<ExternalsiteAuthorization>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalsiteAuthorization" /> class.
        /// </summary>
        ...
        public ExternalsiteAuthorization(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamAccountRef Account = default(IamAccountRef), bool? IsPasswordSet = default(bool?), bool? IsUserIdSet = default(bool?), string Password = default(string), RepositoryTypeEnum? RepositoryType = RepositoryTypeEnum.Cisco, string UserId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalsiteAuthorization {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExternalsiteAuthorization);
        }

        /// <summary>
        /// Returns true if ExternalsiteAuthorization instances are equal
        /// </summary>
        /// <param name="other">Instance of ExternalsiteAuthorization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalsiteAuthorization other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
