...
{
    /// <summary>
    /// Specifies configuration to automatically generate support tickets with Cisco TAC 
    /// </summary>
    [DataContract]
    public partial class HyperflexAutoSupportPolicy :  IEquatable<HyperflexAutoSupportPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        public HyperflexAutoSupportPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), bool? AdminState = default(bool?), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), IamAccountRef Organization = default(IamAccountRef), string ServiceTicketReceipient = default(string))
        {
        ...
        /// </summary>
        /// <value>Enable or disable Auto Support  </value>
        ...
        /// <summary>
        /// Email address recipient for support tickets   
        /// </summary>
        /// <value>Email address recipient for support tickets   </value>
        [DataMember(Name="ServiceTicketReceipient", EmitDefaultValue=false)]
        public string ServiceTicketReceipient { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HyperflexAutoSupportPolicy {\n");
            ...
            sb.Append("  ServiceTicketReceipient: ").Append(ServiceTicketReceipient).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HyperflexAutoSupportPolicy);
        }

        /// <summary>
        /// Returns true if HyperflexAutoSupportPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of HyperflexAutoSupportPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperflexAutoSupportPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ServiceTicketReceipient == other.ServiceTicketReceipient ||
                    this.ServiceTicketReceipient != null &&
                    this.ServiceTicketReceipient.Equals(other.ServiceTicketReceipient)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ServiceTicketReceipient != null)
                    hash = hash * 59 + this.ServiceTicketReceipient.GetHashCode();
                return hash;
            }
        }
