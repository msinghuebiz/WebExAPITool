...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class DeviceinfoSerialNumberInfo :  IEquatable<DeviceinfoSerialNumberInfo>, IValidatableObject
    {
        ...
        public DeviceinfoSerialNumberInfo(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
