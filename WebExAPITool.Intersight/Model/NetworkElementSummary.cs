...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class NetworkElementSummary :  IEquatable<NetworkElementSummary>, IValidatableObject
    {
        ...
        public NetworkElementSummary(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
