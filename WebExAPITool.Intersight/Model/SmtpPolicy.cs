...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class SmtpPolicy :  IEquatable<SmtpPolicy>, IValidatableObject
    {
        ...
        public SmtpPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), bool? Enabled = default(bool?), MinSeverityEnum? MinSeverity = MinSeverityEnum.Critical, IamAccountRef Organization = default(IamAccountRef), List<PolicyAbstractConfigProfileRef> Profiles = default(List<PolicyAbstractConfigProfileRef>), long? SmtpPort = default(long?), List<string> SmtpRecipients = default(List<string>), string SmtpServer = default(string))
        {
