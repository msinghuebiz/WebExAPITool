...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemoryArray :  IEquatable<MemoryArray>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets MaxDevices
        /// </summary>
        [DataMember(Name="MaxDevices", EmitDefaultValue=false)]
        public string MaxDevices { get; private set; }
        ...
        public List<MemoryUnitRef> Units { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaxDevices: ").Append(MaxDevices).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MemoryArray);
        }

        /// <summary>
        /// Returns true if MemoryArray instances are equal
        /// </summary>
        /// <param name="other">Instance of MemoryArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemoryArray other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.CurrentCapacity.Equals(other.CurrentCapacity)
                ) && 
                (
                    this.ErrorCorrection == other.ErrorCorrection ||
                    this.ErrorCorrection != null &&
                    this.ErrorCorrection.Equals(other.ErrorCorrection)
                ) && 
                (
                    this.MaxCapacity == other.MaxCapacity ||
                    this.MaxCapacity != null &&
                    this.MaxCapacity.Equals(other.MaxCapacity)
                ) && 
                (
                    this.MaxDevices == other.MaxDevices ||
                    this.MaxDevices != null &&
                    this.MaxDevices.Equals(other.MaxDevices)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CurrentCapacity != null)
                    hash = hash * 59 + this.CurrentCapacity.GetHashCode();
                if (this.ErrorCorrection != null)
                    hash = hash * 59 + this.ErrorCorrection.GetHashCode();
                if (this.MaxCapacity != null)
                    hash = hash * 59 + this.MaxCapacity.GetHashCode();
                if (this.MaxDevices != null)
                    hash = hash * 59 + this.MaxDevices.GetHashCode();
