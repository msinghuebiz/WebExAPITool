...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexClusterStoragePolicy :  IEquatable<HyperflexClusterStoragePolicy>, IValidatableObject
    {
        ...
        /// <param name="VdiOptimization">Enable or disable VDI optimization (hybrid HX systems only)   .</param>
        public HyperflexClusterStoragePolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), List<HyperflexClusterProfileRef> ClusterProfiles = default(List<HyperflexClusterProfileRef>), bool? DiskPartitionCleanup = default(bool?), IamAccountRef Organization = default(IamAccountRef), bool? VdiOptimization = default(bool?))
        {
        ...
        /// <summary>
        /// Enable or disable VDI optimization (hybrid HX systems only)   
        /// </summary>
        /// <value>Enable or disable VDI optimization (hybrid HX systems only)   </value>
