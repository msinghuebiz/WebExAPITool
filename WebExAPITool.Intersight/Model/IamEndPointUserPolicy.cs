...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IamEndPointUserPolicy :  IEquatable<IamEndPointUserPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Relationship to the collection of Endpoint user roles </value>
        [DataMember(Name="EndPointUserRoles", EmitDefaultValue=false)]
        public List<IamEndPointUserRoleRef> EndPointUserRoles { get; set; }
        ...
        /// </summary>
        /// <value>Set password properties for endpoint users   </value>
        [DataMember(Name="PasswordProperties", EmitDefaultValue=false)]
        public IamEndPointPasswordProperties PasswordProperties { get; set; }

        /// <summary>
        /// Relationship to the server profile object 
        /// </summary>
        /// <value>Relationship to the server profile object </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IamEndPointUserPolicy {\n");
            ...
            sb.Append("  EndPointUserRoles: ").Append(EndPointUserRoles).Append("\n");
            sb.Append("  Organization: ").Append(Organization).Append("\n");
            sb.Append("  PasswordProperties: ").Append(PasswordProperties).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IamEndPointUserPolicy);
        }

        /// <summary>
        /// Returns true if IamEndPointUserPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of IamEndPointUserPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IamEndPointUserPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.EndPointUserRoles == other.EndPointUserRoles ||
                    this.EndPointUserRoles != null &&
                    this.EndPointUserRoles.SequenceEqual(other.EndPointUserRoles)
                ) && 
                (
                ...
                (
                    this.PasswordProperties == other.PasswordProperties ||
                    this.PasswordProperties != null &&
                    this.PasswordProperties.Equals(other.PasswordProperties)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EndPointUserRoles != null)
                    hash = hash * 59 + this.EndPointUserRoles.GetHashCode();
                if (this.Organization != null)
                    hash = hash * 59 + this.Organization.GetHashCode();
                if (this.PasswordProperties != null)
                    hash = hash * 59 + this.PasswordProperties.GetHashCode();
