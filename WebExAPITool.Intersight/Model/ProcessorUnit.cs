...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessorUnit :  IEquatable<ProcessorUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorUnit" /> class.
        /// </summary>
        ...
        public ProcessorUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), ComputeBoardRef ComputeBoard = default(ComputeBoardRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        public long? NumCores { get; private set; }

        /// <summary>
        /// Gets or Sets NumCoresEnabled
        /// </summary>
        [DataMember(Name="NumCoresEnabled", EmitDefaultValue=false)]
        public string NumCoresEnabled { get; private set; }

        /// <summary>
        /// Gets or Sets NumThreads
        /// </summary>
        [DataMember(Name="NumThreads", EmitDefaultValue=false)]
        public string NumThreads { get; private set; }
        ...
        public long? ProcessorId { get; private set; }
        ...
        /// <summary>
        /// Gets or Sets SocketDesignation
        /// </summary>
        [DataMember(Name="SocketDesignation", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumCoresEnabled: ").Append(NumCoresEnabled).Append("\n");
            ...
            sb.Append("  SocketDesignation: ").Append(SocketDesignation).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessorUnit);
        }

        /// <summary>
        /// Returns true if ProcessorUnit instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessorUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessorUnit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.NumCores != null &&
                    this.NumCores.Equals(other.NumCores)
                ) && 
                (
                    this.NumCoresEnabled == other.NumCoresEnabled ||
                    this.NumCoresEnabled != null &&
                    this.NumCoresEnabled.Equals(other.NumCoresEnabled)
                ) && 
                (
                ...
                (
                    this.SocketDesignation == other.SocketDesignation ||
                    this.SocketDesignation != null &&
                    this.SocketDesignation.Equals(other.SocketDesignation)
                ) && 
                (
                ...
                (
                    this.Stepping == other.Stepping ||
                    this.Stepping != null &&
                    this.Stepping.Equals(other.Stepping)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NumCores != null)
                    hash = hash * 59 + this.NumCores.GetHashCode();
                if (this.NumCoresEnabled != null)
                    hash = hash * 59 + this.NumCoresEnabled.GetHashCode();
                ...
                if (this.SocketDesignation != null)
                    hash = hash * 59 + this.SocketDesignation.GetHashCode();
                if (this.Speed != null)
                    hash = hash * 59 + this.Speed.GetHashCode();
                if (this.Stepping != null)
                    hash = hash * 59 + this.Stepping.GetHashCode();
