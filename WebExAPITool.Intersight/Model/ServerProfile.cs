...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class ServerProfile :  IEquatable<ServerProfile>, IValidatableObject
    {
        ...
        public ServerProfile(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), PolicyAbstractProfileRef SrcTemplate = default(PolicyAbstractProfileRef), TypeEnum? Type = TypeEnum.Instance, string Action = default(string), PolicyConfigContext ConfigContext = default(PolicyConfigContext), ComputeRackUnitRef AssignedServer = default(ComputeRackUnitRef), ComputeRackUnitRef AssociatedServer = default(ComputeRackUnitRef), ServerConfigChangeDetailsRef ConfigChangeDetails = default(ServerConfigChangeDetailsRef), ServerConfigChange ConfigChanges = default(ServerConfigChange), ServerConfigResultRef ConfigResult = default(ServerConfigResultRef), IamAccountRef Organization = default(IamAccountRef))
        {
        ...
        public ServerConfigChangeDetailsRef ConfigChangeDetails { get; set; }
        ...
        public ServerConfigChange ConfigChanges { get; set; }
        ...
        public bool Equals(ServerProfile other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ConfigChangeDetails.Equals(other.ConfigChangeDetails)
                ) && 
                (
