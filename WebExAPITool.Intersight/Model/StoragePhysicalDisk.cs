...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class StoragePhysicalDisk :  IEquatable<StoragePhysicalDisk>, IValidatableObject
    {
        ...
        public StoragePhysicalDisk(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string DriveFirmware = default(string), string FdeCapable = default(string), EquipmentLocatorLedRef LocatorLed = default(EquipmentLocatorLedRef), StoragePhysicalDiskExtensionRef PhysicalDiskExtension = default(StoragePhysicalDiskExtensionRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<FirmwareRunningFirmwareRef> RunningFirmware = default(List<FirmwareRunningFirmwareRef>), StorageControllerRef StorageController = default(StorageControllerRef), StorageEnclosureRef StorageEnclosure = default(StorageEnclosureRef))
        {
