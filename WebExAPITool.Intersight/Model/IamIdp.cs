...
{
    /// <summary>
    /// IDP represents SAML identity provider like Cisco used for logging into Intersight 
    /// </summary>
    [DataContract]
    public partial class IamIdp :  IEquatable<IamIdp>, IValidatableObject
    {
        ...
        public IamIdp(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamAccountRef Account = default(IamAccountRef), IamSystemRef System = default(IamSystemRef))
        {
        ...
        /// <summary>
        /// Configuration status of IDP   
        /// </summary>
        /// <value>Configuration status of IDP   </value>
