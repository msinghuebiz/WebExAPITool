...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentDeviceSummary :  IEquatable<EquipmentDeviceSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentDeviceSummary" /> class.
        /// </summary>
        ...
        public EquipmentDeviceSummary(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        /// </summary>
        /// <value>The distinguished name for the Network Element  </value>
        [DataMember(Name="Dn", EmitDefaultValue=false)]
        public string Dn { get; private set; }

        /// <summary>
        /// The model number for the Network Element  
        /// </summary>
        /// <value>The model number for the Network Element  </value>
        ...
        /// </summary>
        /// <value>The serial number for the Network Element  </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentDeviceSummary {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentDeviceSummary);
        }

        /// <summary>
        /// Returns true if EquipmentDeviceSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentDeviceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentDeviceSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
