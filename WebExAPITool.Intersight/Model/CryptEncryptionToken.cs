...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class CryptEncryptionToken :  IEquatable<CryptEncryptionToken>, IValidatableObject
    {
        ...
        public CryptEncryptionToken(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), CryptAccountKeyRef AccountKey = default(CryptAccountKeyRef), bool? Wrapped = default(bool?))
        {
