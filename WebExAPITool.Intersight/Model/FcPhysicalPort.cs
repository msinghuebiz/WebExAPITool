...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FcPhysicalPort :  IEquatable<FcPhysicalPort>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FcPhysicalPort" /> class.
        /// </summary>
        ...
        public string Wwn { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FcPhysicalPort {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FcPhysicalPort);
        }

        /// <summary>
        /// Returns true if FcPhysicalPort instances are equal
        /// </summary>
        /// <param name="other">Instance of FcPhysicalPort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FcPhysicalPort other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Wwn != null)
                    hash = hash * 59 + this.Wwn.GetHashCode();
                return hash;
            }
        }
