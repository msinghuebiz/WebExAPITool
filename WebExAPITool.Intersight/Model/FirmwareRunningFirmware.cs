...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FirmwareRunningFirmware :  IEquatable<FirmwareRunningFirmware>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets BiosUnit
        /// </summary>
        [DataMember(Name="BiosUnit", EmitDefaultValue=false)]
        public BiosUnitRef BiosUnit { get; set; }

        /// <summary>
        /// represents the kind of firmware - boot-booloader/system/kernel  
        /// </summary>
        /// <value>represents the kind of firmware - boot-booloader/system/kernel  </value>
        ...
        /// </summary>
        /// <value>represents the packageVersion to which the firmware belongs to  </value>
        ...
        /// <summary>
        /// Gets or Sets StoragePhysicalDisk
        /// </summary>
        [DataMember(Name="StoragePhysicalDisk", EmitDefaultValue=false)]
        public StoragePhysicalDiskRef StoragePhysicalDisk { get; set; }
        ...
        /// </summary>
        /// <value>represents the version of the firmware   </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FirmwareRunningFirmware {\n");
            ...
            sb.Append("  BiosUnit: ").Append(BiosUnit).Append("\n");
            ...
            sb.Append("  StoragePhysicalDisk: ").Append(StoragePhysicalDisk).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FirmwareRunningFirmware);
        }

        /// <summary>
        /// Returns true if FirmwareRunningFirmware instances are equal
        /// </summary>
        /// <param name="other">Instance of FirmwareRunningFirmware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FirmwareRunningFirmware other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.BiosUnit == other.BiosUnit ||
                    this.BiosUnit != null &&
                    this.BiosUnit.Equals(other.BiosUnit)
                ) && 
                (
                ...
                (
                    ...
                    this.PackageVersion.Equals(other.PackageVersion)
                ) && 
                (
                ...
                (
                    this.StoragePhysicalDisk == other.StoragePhysicalDisk ||
                    this.StoragePhysicalDisk != null &&
                    this.StoragePhysicalDisk.Equals(other.StoragePhysicalDisk)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BiosUnit != null)
                    hash = hash * 59 + this.BiosUnit.GetHashCode();
                ...
                if (this.PackageVersion != null)
                    hash = hash * 59 + this.PackageVersion.GetHashCode();
                ...
                if (this.StoragePhysicalDisk != null)
                    hash = hash * 59 + this.StoragePhysicalDisk.GetHashCode();
                if (this.Type != null)
