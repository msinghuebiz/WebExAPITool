...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexAlarm :  IEquatable<HyperflexAlarm>, IValidatableObject
    {
        ...
        public HyperflexAlarm(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), HyperflexClusterRef Cluster = default(HyperflexClusterRef), HyperflexManagedObjectReference Entity = default(HyperflexManagedObjectReference), HyperflexManagedObjectReference Mor = default(HyperflexManagedObjectReference))
        {
