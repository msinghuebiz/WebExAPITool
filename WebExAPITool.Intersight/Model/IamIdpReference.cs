...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IamIdpReference :  IEquatable<IamIdpReference>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IamIdpReference {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IamIdpReference);
        }

        /// <summary>
        /// Returns true if IamIdpReference instances are equal
        /// </summary>
        /// <param name="other">Instance of IamIdpReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IamIdpReference other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
