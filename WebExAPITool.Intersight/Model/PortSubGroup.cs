...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortSubGroup :  IEquatable<PortSubGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public PortSubGroup(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), List<EtherPhysicalPortRef> EthernetPorts = default(List<EtherPhysicalPortRef>), PortGroupRef PortGroup = default(PortGroupRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PortSubGroup);
        }

        /// <summary>
        /// Returns true if PortSubGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of PortSubGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortSubGroup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
