...
{
    /// <summary>
    /// Represents web session of a user. After successful login to Intersight, a session object is created. Session object is deleted upon logout, idle timeout, expiry timeout or manual deletion 
    /// </summary>
    [DataContract]
    public partial class IamSession :  IEquatable<IamSession>, IValidatableObject
    {
        ...
        /// <summary>
        /// Represents the user agent IP address from where the session is launched  
        /// </summary>
        /// <value>Represents the user agent IP address from where the session is launched  </value>
        ...
        /// <summary>
        /// Specifies client address from where last successful login is initiated  
        /// </summary>
        /// <value>Specifies client address from where last successful login is initiated  </value>
