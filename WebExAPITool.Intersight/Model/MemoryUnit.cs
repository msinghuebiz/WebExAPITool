...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class MemoryUnit :  IEquatable<MemoryUnit>, IValidatableObject
    {
        ...
        public MemoryUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MemoryArrayRef MemoryArray = default(MemoryArrayRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
