...
{
    /// <summary>
    /// A collection of privilege sets. System creates default roles like Account Administrator, Read Only 
    /// </summary>
    [DataContract]
    public partial class IamRole :  IEquatable<IamRole>, IValidatableObject
    {
        ...
        public IamRole(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), IamAccountRef Account = default(IamAccountRef), string Name = default(string), List<IamPrivilegeSetRef> PrivilegeSets = default(List<IamPrivilegeSetRef>), IamSystemRef System = default(IamSystemRef))
        {
