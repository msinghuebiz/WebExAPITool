...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexConfigResultEntry :  IEquatable<HyperflexConfigResultEntry>, IValidatableObject
    {
        ...
        public HyperflexConfigResultEntry(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string CompletedTime = default(string), PolicyConfigResultContext Context = default(PolicyConfigResultContext), string Message = default(string), string OwnerId = default(string), string State = default(string), string Type = default(string), HyperflexConfigResultRef ConfigResult = default(HyperflexConfigResultRef))
        {
