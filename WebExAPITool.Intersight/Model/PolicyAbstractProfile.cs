...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class PolicyAbstractProfile :  IEquatable<PolicyAbstractProfile>, IValidatableObject
    {
        ...
        public PolicyAbstractProfile(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string Description = default(string), string Name = default(string), PolicyAbstractProfileRef SrcTemplate = default(PolicyAbstractProfileRef), TypeEnum? Type = TypeEnum.Instance)
        {
