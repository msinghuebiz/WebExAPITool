...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class AssetDeviceConfiguration :  IEquatable<AssetDeviceConfiguration>, IValidatableObject
    {
        ...
        public AssetDeviceConfiguration(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), AssetDeviceRegistrationRef Device = default(AssetDeviceRegistrationRef), bool? LocalConfigurationLocked = default(bool?), string LogLevel = default(string))
        {
