...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class EquipmentBase :  IEquatable<EquipmentBase>, IValidatableObject
    {
        ...
        public EquipmentBase(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentBase);
        }

        /// <summary>
        /// Returns true if EquipmentBase instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
