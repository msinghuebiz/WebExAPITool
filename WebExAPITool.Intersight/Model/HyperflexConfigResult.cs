...
namespace WebExAPITool.Intersight.Model
{
    ...
    public partial class HyperflexConfigResult :  IEquatable<HyperflexConfigResult>, IValidatableObject
    {
        ...
        public HyperflexConfigResult(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), string ConfigStage = default(string), string ConfigState = default(string), string ValidationState = default(string), HyperflexClusterProfileRef ClusterProfile = default(HyperflexClusterProfileRef), string ConfigProgress = default(string), string Duration = default(string), List<HyperflexConfigResultEntryRef> ResultEntries = default(List<HyperflexConfigResultEntryRef>), string StartTime = default(string))
        {
