...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InventoryGenericInventoryHolder :  IEquatable<InventoryGenericInventoryHolder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets GenericInventory
        /// </summary>
        [DataMember(Name="GenericInventory", EmitDefaultValue=false)]
        public List<InventoryGenericInventoryRef> GenericInventory { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventoryGenericInventoryHolder {\n");
            ...
            sb.Append("  GenericInventory: ").Append(GenericInventory).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InventoryGenericInventoryHolder);
        }

        /// <summary>
        /// Returns true if InventoryGenericInventoryHolder instances are equal
        /// </summary>
        /// <param name="other">Instance of InventoryGenericInventoryHolder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryGenericInventoryHolder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.GenericInventory == other.GenericInventory ||
                    this.GenericInventory != null &&
                    this.GenericInventory.SequenceEqual(other.GenericInventory)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GenericInventory != null)
                    hash = hash * 59 + this.GenericInventory.GetHashCode();
