...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortPhysical :  IEquatable<PortPhysical>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortPhysical" /> class.
        /// </summary>
        ...
        public PortPhysical(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PortPhysical);
        }

        /// <summary>
        /// Returns true if PortPhysical instances are equal
        /// </summary>
        /// <param name="other">Instance of PortPhysical to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortPhysical other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
