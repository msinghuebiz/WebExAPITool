...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortGroup :  IEquatable<PortGroup>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets EquipmentSwitchCard
        /// </summary>
        [DataMember(Name="EquipmentSwitchCard", EmitDefaultValue=false)]
        public EquipmentSwitchCardRef EquipmentSwitchCard { get; set; }

        /// <summary>
        /// Gets or Sets EthernetPorts
        /// </summary>
        [DataMember(Name="EthernetPorts", EmitDefaultValue=false)]
        public List<EtherPhysicalPortRef> EthernetPorts { get; set; }

        /// <summary>
        /// Gets or Sets FcPorts
        /// </summary>
        [DataMember(Name="FcPorts", EmitDefaultValue=false)]
        public List<FcPhysicalPortRef> FcPorts { get; set; }
        ...
        public List<PortSubGroupRef> SubGroups { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EquipmentSwitchCard: ").Append(EquipmentSwitchCard).Append("\n");
            sb.Append("  EthernetPorts: ").Append(EthernetPorts).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PortGroup);
        }

        /// <summary>
        /// Returns true if PortGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of PortGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortGroup other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.EquipmentSwitchCard == other.EquipmentSwitchCard ||
                    this.EquipmentSwitchCard != null &&
                    this.EquipmentSwitchCard.Equals(other.EquipmentSwitchCard)
                ) && 
                (
                    this.EthernetPorts == other.EthernetPorts ||
                    this.EthernetPorts != null &&
                    this.EthernetPorts.SequenceEqual(other.EthernetPorts)
                ) && 
                (
                    this.FcPorts == other.FcPorts ||
                    this.FcPorts != null &&
                    this.FcPorts.SequenceEqual(other.FcPorts)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EquipmentSwitchCard != null)
                    hash = hash * 59 + this.EquipmentSwitchCard.GetHashCode();
                if (this.EthernetPorts != null)
                    hash = hash * 59 + this.EthernetPorts.GetHashCode();
                if (this.FcPorts != null)
                    hash = hash * 59 + this.FcPorts.GetHashCode();
