...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentSwitchCard :  IEquatable<EquipmentSwitchCard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets NumPorts
        /// </summary>
        [DataMember(Name="NumPorts", EmitDefaultValue=false)]
        public long? NumPorts { get; private set; }

        /// <summary>
        /// Gets or Sets PortGroups
        /// </summary>
        [DataMember(Name="PortGroups", EmitDefaultValue=false)]
        public List<PortGroupRef> PortGroups { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentSwitchCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentSwitchCard);
        }

        /// <summary>
        /// Returns true if EquipmentSwitchCard instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentSwitchCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentSwitchCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.NumPorts == other.NumPorts ||
                    this.NumPorts != null &&
                    this.NumPorts.Equals(other.NumPorts)
                ) && 
                (
                    this.PortGroups == other.PortGroups ||
                    this.PortGroups != null &&
                    this.PortGroups.SequenceEqual(other.PortGroups)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NumPorts != null)
                    hash = hash * 59 + this.NumPorts.GetHashCode();
                if (this.PortGroups != null)
                    hash = hash * 59 + this.PortGroups.GetHashCode();
