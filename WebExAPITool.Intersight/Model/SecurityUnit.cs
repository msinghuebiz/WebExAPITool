...
namespace WebExAPITool.Intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SecurityUnit :  IEquatable<SecurityUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityUnit" /> class.
        /// </summary>
        ...
        public SecurityUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), ComputeBoardRef ComputeBoard = default(ComputeBoardRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SecurityUnit);
        }

        /// <summary>
        /// Returns true if SecurityUnit instances are equal
        /// </summary>
        /// <param name="other">Instance of SecurityUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityUnit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Voltage != null &&
                    this.Voltage.Equals(other.Voltage)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Voltage != null)
                    hash = hash * 59 + this.Voltage.GetHashCode();
                return hash;
            }
        }
